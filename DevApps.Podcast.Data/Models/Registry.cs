...
namespace DevApps.Podcast.Data.Models
{
    ...
    /// at HKEY_CURRENT_USER\Software\Trasys\ or defined by the Root property
    /// </summary>
    public class Registry : IDisposable
    {
        #region DECLARATION 

        private const string _defaultRoot = @"Software\DevApps\";
        ...
        /// </summary>
        public Registry() : this(_defaultRoot, string.Empty, string.Empty)
        {
        }
        ...
        /// Initialize a new instance of registry
        /// </summary>
        /// <param name="root">Root name (ex. Software\Trasys)</param>
        /// <param name="application">Software name</param>
        /// <param name="section">Configuration section name</param>
        ...
        /// Initialize a new instance of registry
        /// </summary>
        /// <param name="path">Full path to the registry folder (ex. Software\Trasys\MyApplication\MyData)</param>
